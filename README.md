...
#### ➡️ Type the following commands To use SMS B0mber in Termux:
...
```shell script
git clone https://github.com/D3V_S4NJ4Y/SMSBOMB.git
```
...
#### ➡️ Type the following commands To use SMS B0mber in GNU/Linux terminal.
...
## TODO:
 ...
 - [ ] Add More Mail Sp@m APIs 
 - [ ] Add More SMS Sp@m APIs 
 - [ ] Add More Call Sp@m APIs 
...
**A:** There is no official website/app yet.The only official releases of SMSBOMB are published in [Github] (https://github.com/D3V_S4NJ4Y/SMSBOMB.git)
